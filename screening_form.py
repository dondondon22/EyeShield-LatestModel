...
class ScreeningPage(QWidget):
    ...
    def create_unified_page(self):
        ...
        self.va_left = QLineEdit(self)
        self.va_left.hide()
        self.va_left.setPlaceholderText("e.g. 20/20")
        self.va_right = QLineEdit(self)
        self.va_right.hide()
        ...
        self.bp_systolic = QSpinBox(self)
        self.bp_systolic.hide()
        ...
        self.bp_diastolic = QSpinBox(self)
        self.bp_diastolic.hide()
        ...
        tags_w = QWidget(self)
        tags_w.hide()
        tags_h = QHBoxLayout(tags_w)
        tags_h.setSpacing(8)
        tags_h.setContentsMargins(0, 0, 0, 0)
        self.symptom_blurred = SymptomTag("Blurred vision", tags_w)
        self.symptom_floaters = SymptomTag("Floaters", tags_w)
        self.symptom_flashes = SymptomTag("Flashes", tags_w)
        self.symptom_vision_loss = SymptomTag("Vision loss", tags_w)
        for t in (self.symptom_blurred, self.symptom_floaters, self.symptom_flashes, self.symptom_vision_loss):
            tags_h.addWidget(t)
        self.symptom_other = QLineEdit(tags_w)
        ...
        self.hba1c = QDoubleSpinBox(self)
        self.hba1c.hide()
    ...
    def _set_tab_order_unified(self):
        ...
        self.setTabOrder(self.diabetes_duration, self.prev_treatment)
        self.setTabOrder(self.prev_treatment, self.btn_upload)
